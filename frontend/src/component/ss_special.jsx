...
const SSSpecialCarousel = ({ products }) => {
  ...
  return (
    <section
      className="relative rounded-sm bg-gradient-to-br from-rose-50 via-white to-amber-50 border border-rose-200/40 px-4 md:px-10 pb-8 select-none"
    ...
    >
      ...
      >
        {extendedProducts.map((item, i) => (
          ...
          >
            ...
            {item.isFeatured && (
              <span className="absolute top-4 left-4 bg-rose-600 text-white text-xs font-semibold px-3 py-1 rounded-full uppercase tracking-wide">
                Featured
              </span>
            )}
          </div>
      ...
      <button
        ...
        className="hidden md:flex absolute top-1/2 left-3 -translate-y-1/2 items-center justify-center w-10 h-10 rounded-full bg-amber-400 text-white hover:bg-amber-500 transition"
      >
        ‹
      </button>
      <button
        ...
        className="hidden md:flex absolute top-1/2 right-3 -translate-y-1/2 items-center justify-center w-10 h-10 rounded-full bg-amber-400 text-white hover:bg-amber-500 transition"
      >
        ›
      </button>
