...
const ProductForm = ({ product }) => {
  ...
  return (
    <Container>
      <div className="flex items-center justify-center min-h-[82%] bg-gradient-to-br from-amber-50 via-white to-rose-50">
        <div className="w-full max-w-2xl bg-white  shadow-2xl border border-rose-200 flex flex-col overflow-hidden">
            <div className="w-full py-3 px-8 bg-gradient-to-r from-rose-500 via-amber-300 to-rose-300  shadow text-center">
          ...
          <div className="flex-1 overflow-y-auto px-8 pb-8 custom-scrollbar" style={{ maxHeight: "calc(84vh - 80px)" }}>
